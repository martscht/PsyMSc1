...
Den Messmodellen entnehmen wir, dass die Variablen die latenten Variablen vergleichseweise ähnlich gut messen (ähnlich große Faktorladungen). Wir sehen außerdem, dass die ersten Faktorladungen jeweils auf 1 gesetzt wurden und hier entsprechend keine Signifikanzentscheidung von Nöten ist (wir haben den Wert hier "ohne Unsicherheit" vorgegeben). </mark> Um die Reliabilität beurteilen zu können, schauen wir uns die erklärten Varianzanateile an:
