...
```{r, echo = F}
df <- data.frame(Invarianzstufe = c("konfigural", "metrisch/schwach", "skalar/stark", "strikt", "vollständig"), Annahme = c("gleiche Modellstruktur", "gleiche Modellstruktur und Faktorladungen", "gleiche Modellstruktur, Faktorladungen und Interzepte", "gleiche Modellstruktur, Faktorladungen, Interzepte und Residualvarianzen", "gleiche Modellstruktur und alle Modellparameter sind identisch"), Implikation = c("gleiche Beziehungen zwischen Variablen", "latente Variablen haben gleiche Bedeutung; wahre Anteile vergleichbar, durch Restriktion latenten Varianzen vergleichbar", "Unterschiede in den beobachteten Mittelwerten lassen sich auf Unterschiede in den latenten Mittelwerten zurückführen, Gleichheit latenter Mittelwerte testbar durch Restriktion", "Unterschiede in beobachteten Varianzen oder Reliabilitäten zurückzuführen auf Unterschiede in den latenten Varianzen", "keine Unterschiede zwischen den Gruppen"))
library(htmlTable)
