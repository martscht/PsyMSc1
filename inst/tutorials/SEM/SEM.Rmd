...
<mark style="background-color: orange">  Die folgende Tabelle dient der Übersicht der Invarianzstufen sowie ihrer Implikationen: </mark>
...
library(htmlTable)
htmlTable(df,caption="Invarianzstufen und deren Implikationen", align = "cll")
```
