...
Nach dem Ende der Übung finden Sie im [OLAT Kurs ein kurzes Quiz](https://olat-ce.server.uni-frankfurt.de/olat/auth/RepositoryEntry/8136491044/CourseNode/101501774320599) mit Bezug zu den Inhalten dieser Sitzung.
...
Die Übungsaufgaben finden Sie als Quiz im [OLAT Kurs](https://olat-ce.server.uni-frankfurt.de/olat/auth/RepositoryEntry/8136491044). Für die Bearbeitung der Aufgaben benötigen Sie den `fairplayer` Datensatz. Um diesen zu laden, nutzen Sie bitte
...
Falls Sie die Quiz-Aufgaben lieber im Browser bearbeiten möchten oder diese Sitzung über [Shinyapps.io](https://www.shinyapps.io/) beziehen, können Sie das untenstehende `R`-Fenster benutzen, um den Code für die Übungen zu schreiben und auszuführen.

```{r quiz, exercise = TRUE, exercise.lines = 25}
...
[Schultze, M. (2019). R Crash-Kurs.](https://pandar.netlify.com/post/r-crash-kurs/) Retrieved from https://pandar.netlify.com/post/r-crash-kurs/.
