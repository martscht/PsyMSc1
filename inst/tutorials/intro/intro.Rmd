...
Den gesamten R-Code, der in dieser Sitzung genutzt wird, können Sie [`r fontawesome::fa("download")` ](https://raw.githubusercontent.com/martscht/PsyMSc1/master/inst/scripts/intro.R).
