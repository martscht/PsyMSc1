---
title: "Exploratorische Faktorenanalyse --- Aufgaben und Lösungen"
author: "Julien P. Irmer und Martin Schultze"
date: "3/27/2020"
...
## Datensatz
Im Datensatz *Big5_shortend.rda* befinden sich 15 Items aus dem Big-5 Persönlichkeits Fragebogen. Der Itemwortlaut der verwendeten Items ist
...
Nun müssen Sie zunächst die Daten laden. Das machen Sie mit Hilfe des Paketes "PsyMSc1". Mit data("Big5_shortend", package = "PsyMSc1") laden Sie die Daten ein. 
...
```{r}
data_shortend_all_countries[100, ]
```
...
Wie sehen die Dimensionen Ihrer Datensätze aus?  Der Datensatz data_Emirates_full hat 
...
data_France_full <- data_shortend_all_countries[data_shortend_all_countries$country == "FR", -4] # zum Vergleich nochmals einlesen
data_Emirates_full <- data_shortend_all_countries[data_shortend_all_countries$country == "AE", -4]
data_Germany_full <- data_shortend_all_countries[data_shortend_all_countries$country == "DE", -4]
...
# Aufgabe 4
Führen Sie unabhängig von der Anzahl an vorgeschlagenen Faktoren eine ML-EFA mit fünf Faktoren und obliquer Rotation durch. Die Argumente, die zum gewünschten Ergebnis führen, lauten `fa = "ml"`, `nfactors = 5` und `rotate = "oblimin"`. 
...
Diese Aufgaben werden in OLAT diskutiert.
