...
```{r setup1, echo = F, envir_result  = environmentName(environment())}
a <- -999
```
...
```{r excercise_test, exercise = TRUE, exercise.setup = "setup2", exercise.eval = FALSE, envir_prep = environmentName(environment())}
a
b
```
